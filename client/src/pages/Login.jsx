...
const Login = () => {
  return (
    ...
    <div className="bg-white shadow-md rounded-3xl px-5 py-8 w-full sm:w-[27vw]">
      ...
      <form>
        ...
        <button type='submit' className="w-full py-2 px-4 rounded-md shadow-md text-sm font-medium text-white bg-black ">Log In</button>
      </form>
    </div>
  </div>
  )
